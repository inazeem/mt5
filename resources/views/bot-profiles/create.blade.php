            ...
            <div class="bg-white p-6 rounded-lg shadow">
                ...
                <form method="POST" action="{{ route('bot-profiles.store') }}" class="space-y-6">
                    ...
                    @php
                        ...
                        $selectedEntryTimeframe = old('entry_timeframe', '15m');
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_hold_minutes" min="1" max="1440"
                                   value="{{ old('max_hold_minutes') }}" placeholder="e.g. 60"
                                   class="mt-1 block w-full rounded border-gray-300" />
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center gap-2">
                            <input type="checkbox" id="enable_max_hold" name="enable_max_hold" value="1" {{ old('enable_max_hold') ? 'checked' : '' }} class="rounded border-gray-300" />
